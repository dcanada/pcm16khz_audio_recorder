...
public class SwiftPcm16khzAudioRecorderPlugin: NSObject, FlutterPlugin, AVAudioRecorderDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "pcm16khz_audio_recorder", binaryMessenger: registrar.messenger())
    let instance = SwiftPcm16khzAudioRecorderPlugin()
